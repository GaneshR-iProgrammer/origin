...
public class PermissionUtils {
    ...
    public PermissionUtils(Context context, PermissionResultCallback permissionResultCallback, Fragment fragment) {
    ...
    private boolean checkAndRequestPermissions(ArrayList<String> permissions, int request_code) {
        ...
        if (permissions.size() > 0) {
            ...
            if (!listPermissionsNeeded.isEmpty()) {
                if (fragment != null)
                    fragment.requestPermissions(listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]), request_code);
                else
    ...
    public void onRequestPermissionsResults(int requestCode, String permissions[], int[] grantResults) {
        switch (requestCode) {
            case Constants.REQUEST_PERMISSION_ALL:
